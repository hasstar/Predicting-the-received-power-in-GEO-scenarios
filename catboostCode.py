...
class CatBoostRFETrainer:
    ...
    def run_complete_pipeline(self):
        ...
        print("=" * 80)
        print("\nGenerated files:")
        print("  1. CatBoost_RFE_performance_curves.png")
        print("  2. CatBoost_feature_importance_top20.png")
        print("  3. CatBoost_prediction_scatter.png")
        print("  4. CatBoost_residual_analysis.png")
        print("  5. CatBoost_training_results_summary.txt")
        print("  6. CatBoost_training_results_detailed.xlsx")
        print("  7. CatBoost_RFE_detailed_log.txt - DETAILED FEATURE LIST PER ITERATION")
